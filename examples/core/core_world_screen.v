...
fn main() {
	...
	for !r.window_should_close() {
		...
		cube_screen_position = r.get_world_to_screen(r.Vector3{cube_position.x, cube_position.y +
			2.5, cube_position.z}, camera)
		...
		r.draw_text('Enemy: 100 / 100'.str, int(cube_screen_position.x - r.measure_text('Enemy: 100 / 100'.str,
			20) / 2), int(cube_screen_position.y), 20, r.black)

		r.draw_text('Cube position in screen space coordinates: (${cube_screen_position.x},${cube_screen_position.y})'.str,
			5, 10, 20, r.lime)
